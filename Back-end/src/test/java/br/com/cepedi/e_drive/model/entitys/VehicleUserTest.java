...
//    void setUp() {
//        faker = new Faker();
//        user = new User(); // Certifique-se de que User tem um ID válido ou use um mock
//        vehicle = new Vehicle(); // Certifique-se de que Vehicle tem um ID válido ou use um mock
//
