...
export class ModalFormVehicleComponent {
  ...
  fillForm() {
   ...
   /**
   * Carrega a lista de marcas disponíveis chamando o serviço correspondente.
   */
  loadBrands() {
...
/**
 * Cria a requisição de dados do veículo.
 *
 * @returns {IVehicleRequest} Dados do veículo a serem enviados na requisição
 */
 ...
 */
  ...
  /**
 * Exibe uma mensagem de erro caso a operação falhe.
 *
 * @param {string} action - Ação realizada (cadastrar ou atualizar)
 */
